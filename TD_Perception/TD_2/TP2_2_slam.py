...
class SimpleSLAM:
    ...
    def _computeKeyFrame(self, tps, I0, I1):
        ...
        kp0 = 'A COMPLETER'
        kp1 = 'A COMPLETER'
        kp0, desc0 = 'A COMPLETER'
        kp1, desc1 = 'A COMPLETER'
        #======================================================================
    ...
    def _suivitTemporel(self, I0):
        ...
        image_pts  = pts1.reshape([N,1,2])
        
        retval, r, t, inliers_idx = cv2.solvePnPRansac(object_pts, image_pts, self.K0, self.distortion)
...
#%%
################################################################################
# Question : effectuer cette étude sur la séquence s03, les résultats sont-ils le
#            même?
################################################################################
# Réponse :
################################################################################